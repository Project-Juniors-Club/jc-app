  ...
  return (
    <nav className='navbar mb-1.5 flex flex-row flex-wrap items-center justify-between bg-white px-0 pr-12 pl-4 shadow-lg'>
      ...
      <div className='nav-action-menu order-1 flex flex-row items-center gap-6 p-0 '>
        ...
        <div className='button flex h-[48px] w-[120px] flex-row items-center justify-center rounded-lg border border-black'>
          <a href='#' className=' inline-block rounded border border-transparent px-4 py-2 text-sm leading-none text-black'>
            Log In
          </a>
        </div>
      </div>
