...
const MyAccordion = () => {
  const [items, setItems] = useState([
    {
      uuid: uuidv4(),
      title: <Editable defaultValue='Chapter 1'><EditablePreview /><EditableInput /></Editable>,
      content: <MyTable/>,
    },
  ]);
  ...
  const addAccordion = () => {
    const newItem = {
      uuid: uuidv4(),
      title: <Editable defaultValue='New Chapter'><EditablePreview /><EditableInput /></Editable>,
      content: <MyTable/>,
    };
  ...
  return (
    <Accordion defaultIndex={[0]}>
      ...
      <AccordionItem>
      <AccordionButton onClick={addAccordion}>
        <Box as="span" flex='1' textAlign='left'>
          Add Chapter
        </Box>
        +
