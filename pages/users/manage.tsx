import {
    ...
    ModalFooter,
    ModalBody,
    ModalCloseButton, Input, Box, Center, Flex, Container, HStack, VStack, Image, Text, Button, Stack } from '@chakra-ui/react';
        ...
        <>
            <Modal isOpen={showDeleteModal === 1} onClose={() => setDeleteModal(0)}>
                ...
                <ModalContent minW="600px">
                    ...
                    <ModalBody>
                        <Center>
                            <h1 className='pb-6 pt-7 text-4xl font-bold '>
                                {`Delete Account`}
                            </h1>
                        </Center>
                        <Box>
                    ...
                    <Box className='p-6 pb-8'>
                        <Center>
                            ...
                            <CustomButton
                                  onClick={async () => { await submitOtp(session?.user.email, otp, 2); }}
                                  variant={'black-solid'}>
                ...
                <ModalContent minW="600px">
                    ...
                    <Box className='pb-8 pt-6'>
                        <Center>
                            ...
                            <CustomButton onClick={async () => { await submitOtp(session?.user.email, otp, 3); }}
                                          variant={'black-solid'}>
                                <Text color={'#FFFFFF'}>Submit</Text>
                            </CustomButton>
                        </Center>
                                ...
                                <Box className='pl-2 pr-2'>
                                    ...
                                    <Text mb='16px' className=''>
                                        If you did not request to delete your account, please cancel the request here:&nbsp;
                                         <u><a href="mailto:juniorsclub.nus+deletereq@gmail.com">link</a></u>
                                    </Text>
